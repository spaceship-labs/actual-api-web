...
var freesaleTemplate = fs
  ...
  .toString();
var registerTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/register.html')
  .toString();
var fiscalDataTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/fiscal-data.html')
  .toString();
var contactTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/contact.html')
  .toString();
var quotationLogTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/quotation-log.html')
  .toString();
var speiInstructionsTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/spei-instructions.html')
  .toString();
var speiReminderTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/spei-reminder.html')
  .toString();
var speiExpirationTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/spei-expiration.html')
  .toString();
var fiscalDataClientMessageTemplate = fs
  .readFileSync(sails.config.appPath + '/views/email/fiscal-data-client-message.html')
  .toString();
...
function quotationEmail(totalQuotation, params, products) {
  ...
  var toAux2 = new helper.Email('keila@actualstudio.com', 'keila');
  var toAux3 = new helper.Email('asanchez@actualdecoracion.net', 'Alia Sanchez');
  var toAux5 = new helper.Email('gibran@spaceshiplabs.com', 'Gibrán');
  var toAux6 = new helper.Email('sergiocan@spaceshiplabs.com', 'Sergio');
...
function sendRegisterInvitation(userName, userEmail, recoveryUrl) {
  ...
  var content = new helper.Content('text/html', res);
  const toAux2 = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');

  personalization.addTo(to);
  personalization.addBcc(toAux2);
  personalization.setSubject(subject);

  if (process.env.MODE !== 'production') {
    const toAux = new helper.Email('sergiocan@spaceshiplabs.com', 'Emmanuel');
    const toAux3 = new helper.Email('rquijano@actualg.com', 'Rene');
...
function sendRegister(userName, userEmail, store, cb) {
  ...
  var toAux3 = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');
...
function sendRejectedPaymentEmail(params, statusDetail) {
  ...
  const toAux2 = new helper.Email('asanchez@actualdecoracion.net', 'Alia Sanchez');
  const toAux3 = new helper.Email('keila@actualstudio.com', 'keila');
  const toAux4 = new helper.Email('gibran@spaceshiplabs.com', 'Gibrán');
  const toAux5 = new helper.Email('sergiocan@spaceshiplabs.com', 'Sergio');
...
function sendFiscalData(form, store, cb) {
  ...
  var to = new helper.Email('facturacionsitios@actualg.com', 'Facturacion Actual');
  var toAux = new helper.Email('sergiocan@spaceshiplabs.com', 'Luis');
  var toAux2 = new helper.Email('marketing@actualg.com', 'Alia Sanchez');
  var toAux4 = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');
...
function sendFiscalDataMessageToClient(name, email, store, cb) {
  ...
  var toAux4 = new helper.Email('gibran@spaceshiplabs.com', 'Luis');
...
function sendContact(name, email, form, store, cb) {
  ...
  var personalization = new helper.Personalization();
  var from = new helper.Email(email, name);
  var to = new helper.Email('marketing@actualg.com', 'Alia Sanchez');
  var toAux = new helper.Email('sergiocan@spaceshiplabs.com', 'Luis');
  var toAux2 = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');
...
function orderEmail(orderId) {
  return OrderWeb.findOne(orderId)
    ...
    .then(function(order) {
      ...
      details = OrderDetailWeb.find(details)
        .populate('Product')
        .populate('Promotion');
...
function sendOrder(client, order, products, payments, ewallet, store) {
  ...
  var toAux = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');
  var toAux2 = new helper.Email('marketing@actualg.com', 'Alia Sanchez');
  ...
  if (process.env.MODE === 'production') {
    ...
    personalization.addBcc(toAux7);
    personalization.addTo(toAux8);
  }
...
function quotation(quotationId, activeStore, isCardProcessingError, lead) {
  return QuotationWeb.findOne(quotationId)
    .populate('Client')
    .populate('Store')
    .populate('Details')
...
function sendQuotation(
  ...
  var toAux8 = new helper.Email('sergiocan@spaceshiplabs.com', 'Luis');
...
function sendFreesale(order, products, store) {
  ...
  var toAux = new helper.Email('gibran@spaceshiplabs.com', 'Gibran Ramon');
  var toAux2 = new helper.Email('sergiocan@spaceshiplabs.com', 'Luis Perez');
...
function sendQuotationLog(form, store, cb) {
  ...
  var personalization = new helper.Personalization();
  var from = new helper.Email('noreply@actualgroup.com', 'Actual Group');
  var to = new helper.Email('marketing@actualg.com', 'Daniela');
  var toAux = new helper.Email('gibran@spaceshiplabs.com', 'Luis');
