  ...
  sendFiscalData: function(req, res) {
    ...
    var formArr = [
      ...
      { label: 'Folio de compra', value: form.orderFolio },
      {
        ...
        value: moment(form.orderDate || new Date()).format('DD/MM/YYYY')
      },
    ...
    Email.sendFiscalData(formArr, req.activeStore, function() {
