...
var SECRET =
  process.env.tokenSecret || '4ukI0uIVnB3iI1yxj646fVXSE3ZVk4doZgz6fTbNg7jO41EAtl20J5F7Trtwe7OM';
var ALGORITHM = 'HS256';
...
function _onLocalStrategyAuth(email, password, next) {
  UserWeb.findOne({ email: email }).exec(function(error, user) {
    ...
    UserWeb.update({ id: user.id }, { lastLogin: new Date() }).exec(function(err, _user) {
      if (error) return next(error, false, {});
